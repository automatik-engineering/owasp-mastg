...
Apps that target Android 9 (API level 28) or above [will get an error if they specify a security provider](https://android-developers.googleblog.com/2018/03/cryptography-changes-in-android-p.html). The `Crypto` provider was deprecated in Android 7.0 (API level 24) and [removed in Android 9 (API level 28)](https://developer.android.com/about/versions/pie/android-9.0-changes-all#conscrypt_implementations_of_parameters_and_algorithms). The BouncyCastle provider was [deprecated in Android 9 (API level 28) and removed in Android 12 (API level 31)](https://developer.android.com/about/versions/12/behavior-changes-all#bouncy-castle).
